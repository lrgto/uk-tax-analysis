...
salary = np.arange(1.00,salary_max,1.00)
...
# Open CSV File
filename = (dir+"/results/data/Analysis.csv")
f = open(filename, "w+")
...
plt.savefig(dir+"/results/images/Loss_Tax.png",dpi=1000)
plt.close()